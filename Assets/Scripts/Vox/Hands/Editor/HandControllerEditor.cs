...
namespace Vox.Hands {
	...
	public class HandControllerEditor : Editor {
		...
		private void ResetEditor()
		{
            ...
            m_mode = serializedObject.FindProperty("m_timelineEditMode");
		...
		public override void OnInspectorGUI()
		{
            ...
            if (m_currentTarget.TimelineEditMode)
            {
                m_currentTarget.UpdatePreview();
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_previewData"));
		...
		private void OnPresetImageShotTakerSceneViewGUI(SceneView sceneView)
		{
			...
			if (GUI.Button(buttonPos,"Save to Preset"))
            {
                ...
                //Camera.onPostRender += OnPresetIconCapturePostRenderScreenView;
                OnPresetIconCapturePostRenderScreenView(SceneView.lastActiveSceneView.camera);
            }
